...
X=xlsread('E:\论文\Estimation of above ground biomass for winter wheat using digital images and deep convolutional neural network\试验数据\AGB_4\Biomass.xlsx', 'Test');
Biomass=prepareBiomass(X,25);
[filename,filepath]=uigetfile('*.xlsx', '输出xlsx文件');
output=fullfile(filepath,filename);
xlswrite(output,Fresult,'Test', 'A2');
xlswrite(output,Biomass,'Test', 'C2');
